...
class Robot:
    ...
    def generate_min_paths(self):
        ...
        for node_a, node_b in product(nodes_a, nodes_b):
            ...
            local_instructions.sort(key=len)
            ...
            self.instructions[(node_a.symbol, node_b.symbol)] = min_paths
...
class DirectionalRobot(Robot):
    ...
    def generate(self, received_paths):
        ...
        final_instructions.sort(key=len)
